<template>
	<div id="body">
		<div class="login_box">
			...
			<div class="input_box">
				<input type="text" ref="pass1" placeholder="   请输入新密码" />
	...
	methods: {
		async Confirm(){
			var _this = this;
   			...
   			var url = 'users/current/password?tradeId=12&validCode=1232';
   			var obj = {};
   			obj.uid = localStorage.user;
   			// obj.uid = 17733746206
   			obj.password = pass1Val;
   			console.log(obj)
   			let res = await api.put(url,obj)
   			// this.$http.put("api/"+url,obj).then(function(res){
   			// 	console.log(res)
   			// },function(err){
   			// 	console.log(err)
   			// })
