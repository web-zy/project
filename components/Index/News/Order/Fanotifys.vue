    ...
    <div id="saleorders">
      ...
      <div class="subInfo">
        ...
        <div class="info">
          ...
          <div class="a-single">
            <span class="name">到款金额 11111</span>
            <span>：¥{{orderData.trade_amt | formatNum}}</span>
          </div>
        </div>
      </div>
      <div class="tabsWarp">
  ...
  export default {
    data() {
      return {
        ...
        essInfo:[
          ...
          {name:"销账人",content:"",sign:"cancel_person"}
        ],
        detailArrList:[],
        detailsList:[
          {name:"销账人",content:"",sing:"cancelperson"},
    ...
    methods: {
      ...
      async getDelData(){
        ...
        let url = `fanotifys?token=${api.token}&filter=TaskID=${id}`;
