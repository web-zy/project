	...
	<div id="pureturnorders">
        ...
        <div class="subInfo">
        	...
        	<div class="info">
        		...
        		<div class="a-single">共<em style="display:inline-block;width:5px;"></em>{{orderData.total_qty}}<em style="display:inline-block;width:5px;"></em>件<em style="display:inline-block;width:10px;"></em>¥{{orderData.total_in_amt | formatNum}}
					...
					<div class="detailed-list" v-for="(val,index) in details" :key="index" @click="showDetailed(index)">
						<div class="brief-warp">
							...
							<div class="detailed-info">
								...
								<span>{{val.topobj.qty}}件 ¥{{val.topobj.st_amt}}</span>
							</div>
		...
		data() {
			return {
				...
				essInfo:[
					...
					{name:"采购入库单号",content:"",sign:"st_instorage_code"},
					{name:"采购订单号",content:"",sign:"pu_order_code"},
					{name:"发票类型",content:"",sign:"invoice_type"},
					{name:"供应商",content:"",sign:"supplier_name"},
					{name:"供应商联系人",content:"",sign:"contact_name"},
					{name:"供应商联系人电话",content:"",sign:"contact_phone"},
				...
				detailsList:[
					...
					{name:"入库数量",content:"",sing:"instorage_qty"},
			...
			setTrialList(v){
				...
				for(var i=0;i<this.details.length;i++){
					...
					for(let j in this.details[i]){
						...
						if(this.details[i][j].sing == "instorage_qty"){
							index = j;
						}
