	...
	export default {
		data() {
			return {
				...
				details:[],
				detailsList:[
					{name:"仓库名称",content:"",sing:"warehouse_name"},
		...
		methods: {
			...
			async getDelData(){
				...
				//库存期初信息
				this.details=res[0].qc_stock_details_t;
				this.details = utrl.setJson(this.details,this.detailsList);
				utrl.thousand(this.details,"price")
				utrl.thousand(this.details,"amt")
			},
