	...
	<div id="Customer">
			...
			<div class="headerCent">
				...
				<div class="Tabdiv">
					<ul>
						...
						<li class="tab-li">费用明细</li>
						<li class="tab-li">冲借款</li>
						<li class="tab-li">结算方式</li>
		...
		<div class="conent">
			...
			<div class="tab-cons" style="display: block;">
				<div class="basic"><span>费用承担部门</span><span></span></div>
				<div class="basic"><span>费用承担人</span><span></span></div>
				<div class="basic"><span>标题</span><span></span></div>
				<div class="basic"><span>备注</span><span></span></div>
				<div class="basic"><span>实际用途</span><span></span></div>
			</div>
			<!--/*****************费用明细****************/-->
			<div class="tab-cons">
				<ul>
			...
			<div class="tab-cons">
				<ul>
					<li>
						<div class="dt">
							<div>借款单号：&emsp;&emsp;&emsp;借款日期： </div>
							<div>借款事由：</div>
							<div>剩余借款：&emsp;&emsp;&emsp;本次报销金额：</div>
						</div>
					</li>
					<li>
						<div class="dt">
			...
			<div class="tab-cons">
				<ul>
					<li>
						<div class="dt">
							<div>结算方式：&emsp;&emsp;&emsp;金额： </div>
							<div>开户行地区：&emsp;&emsp;收款人：&emsp; &emsp;</div>
							<div>收款人账号：</div>
						</div>
					</li>
					<li>
