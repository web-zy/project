	...
	<div id="Customer">
			...
			<div class="headerCent">
				...
				<div class="Tabdiv">
					<ul>
						...
						<li class="tab-li">合同标的</li>
						<li class="tab-li">付款方式</li>
		...
		<div class="conent">
			...
			<div class="tab-cons" style="display: block;">
				<div class="basic"><span>合同名称</span><span>同辉项目管理2018</span></div>
				<div class="basic"><span>甲方</span><span>同辉</span></div>
				<div class="basic"><span>乙方</span><span>通友时代</span></div>
			...
			<div class="tab-cons">
				<ul>
					<li>
						<div class="nub">1</div>
						<div class="dt">
							<div>首付款 30% 3000.00 （方案签字后付款 备注） </div>
							<div>预计付款日期：2018-09-09</div>
						</div>
					</li>
					<li>
						<div class="nub">2</div>
						<div class="dt">
							<div>验收款 60%  6000.00 （验收单签字后付款） </div>
							<div>预计付款日期：2018-09-09</div>
						</div>
					</li>
					<li>
						...
						<div class="dt">
							<div>
								尾款 10%  1000.00 （上线一个月后付款） 
							</div>
							<div>预计付款日期：2018-12-01</div>
						</div>
					</li>
				</ul>
			</div>
