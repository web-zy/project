<template>
    <section class="myAddress" @click="hide">
        <section>
        ...
        <section class="showChose" v-show="showChose">
          <section class="address">
            ...
            <section class="title">
              <div class="area" @click.stop="provinceSelected">
                 {{Province?Province:info[province-1].name}}
              </div>
              <div class="area" @click.stop="citySelected" :class="City?'':'active'">
                 {{City?City:'请选择'}}
              </div>
...
<script>
    ...
    methods: {
        ...
        provinceSelected: function(e) {
        	...
        	this.$refs.ulleft.style.paddingLeft=e.clientX+"px"
        	console.log(this.$refs.ulleft)
            // 清除市级和区级列表
